      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <div className="flex items-center justify-center mb-4">
            <div className="h-12 w-12 rounded bg-[var(--accent-blue)] flex items-center justify-center">
              <span className="text-white font-bold text-lg">BOM</span>
            </div>
          </div>
          <CardTitle className="text-2xl text-center">Welcome to BOM Wizard</CardTitle>
        ...
        <CardContent className="space-y-4">
          {error && (
            <div className="p-3 text-sm text-[var(--accent-red)] bg-[var(--bg-tertiary)] rounded-md">
              {error}
            </div>
          )}
